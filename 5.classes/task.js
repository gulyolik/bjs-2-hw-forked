...
let novel = new NovelBook("Автор новеллы", "Название новеллы", 1919, 189);
let fantastic = new FantasticBook("Автор фантастики", "Название фантастики", 1898, 570);
let detective = new DetectiveBook("Автор детектива", "Название детектива", 2010, 320);
